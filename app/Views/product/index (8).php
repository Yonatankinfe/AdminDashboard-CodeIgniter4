...
<body>
    ...
    <a href="<?= base_url('product/create'); ?>">Add New Product</a>
        ...
        <ul>
            <?php foreach ($products as $product): ?>
                ...
                <li>
                    ...
                    <a href="<?= base_url('product/delete/' . $product['Title']); ?>" 
                       onclick="return confirm('Are you sure you want to delete this product?');">
                       <br/>
                       Delete
                    </a>
                    <a href="<?= base_url('product/edit/' . urlencode($product['Title'])); ?>">
                        <br/>
                         Update Data
                    </a>
                </li>
...
<head>
  ...
  <!-- CSS Files -->
  <link rel="stylesheet" href="<?= base_url('css/admin/soft-ui-dashboard.css') ?>">
  <link rel="stylesheet" href="<?= base_url('css/admin/soft-ui-dashboard.min.css') ?>">
  <link rel="stylesheet" href="<?= base_url('css/admin/soft-ui-dashboard.css.map') ?>">
  <link rel="stylesheet" href="<?= base_url('css/admin/nucleo-icons.css') ?>">
  <link rel="stylesheet" href="<?= base_url('css/admin/nucleo-svg.css') ?>">
                  ...
                  <div class="row">
                    <div class="col-8 text-start">
                      ...
                      <h5 class="text-white font-weight-bolder mb-0 mt-3">
                        <?php echo $total_post= $total_post -1 ?>
                      </h5>
                      <span class="text-white text-sm">Total Post</span>
                    </div>
                    <div class="col-4">
                ...
                <div class="card-body p-3 position-relative">
                  <div class="row">
                    <div class="col-8 text-start">
                      ...
                      <span class="text-white text-sm">TOP Rated Post</span>
                    </div>
                    <div class="col-4">
                ...
                <div class="card-body p-3 position-relative">
                  <div class="row">
                    <div class="col-8 text-start">
                      ...
                      <span class="text-white text-sm">Total Rating</span>
                    </div>
                    <div class="col-4">
                      <div class="dropdown text-end mb-6">
        ...
        <div class="col-lg-6 col-12 mt-4 mt-lg-0">
          <div class="card shadow h-100">
            <div class="card-header pb-0 p-3">
              <h6 class="mb-0">TOP 3 Rated Postes</h6>
            </div>
      ...
      <div class="row my-4" style="width: 100%;">
        <div class="col-lg-8 col-md-6 mb-md-0 mb-4"style="width: 100%;">
          <div class="card"style="width: 100%;">
            <div class="card-header pb-0"style="width: 100%;">
              <div class="row"style="width: 100%;">
                <div class="col-lg-6 col-7"style="width: 100%;">
                  <h6>Postes</h6>
